...
| 平台 | 版本 | 連結 |
|------|------|------|
| macOS | Universal Binary<br/>（支援 Intel 與 Apple Silicon） | [下載](https://github.com/IDK-Silver/PDF_Tool/releases/download/v3.11.2/Kano.PDF.Tool_3.11.2_universal.dmg) |
| Windows | x64 | [下載](https://github.com/IDK-Silver/PDF_Tool/releases/download/v3.11.2/Kano.PDF.Tool_3.11.2_x64-setup.exe) |
| Linux | x64 (AppImage) | [下載](https://github.com/IDK-Silver/PDF_Tool/releases/download/v3.11.2/Kano.PDF.Tool_3.11.2_amd64.AppImage) |
