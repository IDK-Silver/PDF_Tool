...
| 平台 | 版本 | 連結 |
|------|------|------|
| macOS | Universal Binary<br/>（支援 Intel 與 Apple Silicon） | [下載](https://github.com/IDK-Silver/PDF_Tool/releases/download/v3.9.3/Kano.PDF.Tool_3.9.3_universal.dmg) |
| Windows | x64 | [下載](https://github.com/IDK-Silver/PDF_Tool/releases/download/v3.9.3/Kano.PDF.Tool_3.9.3_x64-setup.exe) |
