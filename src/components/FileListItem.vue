  ...
  >
    ...
    <button class="delete-btn" type="button" title="刪除" aria-label="刪除" @click="onRemove">
      <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        <path stroke-linecap="round" stroke-linejoin="round" d="M6 7h12M9 7V5a2 2 0 012-2h2a2 2 0 012 2v2m1 0v12a2 2 0 01-2 2H8a2 2 0 01-2-2V7z" />
      </svg>
    </button>
  </div>
</template>
...
.leading-icon .icon { width: 16px; height: 16px; color: var(--text-muted, #6b7280); display: block; }
.row.active .leading-icon .icon { color: var(--text, #111827); }
.delete-btn {
  border: none;
...
.delete-btn .icon { width: 16px; height: 16px; }
</style>
